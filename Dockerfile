...
RUN apk add --update wget ca-certificates unzip build-base ruby-dev ruby && \
    ...
    wget -q "https://circle-artifacts.com/gh/unifio/packer-post-processor-vagrant-s3/13/artifacts/0/home/ubuntu/.go_workspace/bin/packer-post-processor-vagrant-s3" && \
